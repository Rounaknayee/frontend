...
function Home() {
    ...
    return(
        <div>
            ...
            <button type="button" 
            id = "home-reg"
            class="text-white bg-gradient-to-tr from-green-600 to-blue-600 hover:bg-gradient-to-bl font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Register
            </button>
            </Link>
            <Link to='/login'>
            <button type="button"
            id = "home-log"
            class="text-white bg-gradient-to-tr from-green-600 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
            Login
            </button>
            </Link>
            </div>
